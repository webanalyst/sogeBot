...
function adminEndpoint (nsp: string, on: 'viewers::update', callback: (data: [userId: string, update: Partial<UserInterface>], cb: (error: Error | string | null, ...response: any) => void) => void): void;
